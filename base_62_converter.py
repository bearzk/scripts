...
UPPERCASE_OFFSET = 55 #A start at 65 = 10 + 55
LOWERCASE_OFFSET = 61 #a start at 97 = 36 + 61
DIGIT_OFFSET = 48 #0 start at 48 = 0 + 48
...
def true_ord(char):
    ...
    if char.isdigit():
        ...
        raise ValueError("%s is not a valid character [0-9a-zA-Z]." % char)
...
def _usage():
    print "use '-s' for saturate or '-d' for dehydrate."
    print "and I don't understand %s" % sys.argv[1]
    sys.exit()
